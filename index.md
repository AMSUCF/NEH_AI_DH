...
The series synthesizes materials from prior work by Dr. Salter, Dr. Stanfill, and collaborators, including ENG 6806 [*Humanities in the Age of AI*](https://anastasiasalter.net/HumanitiesAI/), ENG 6819 [*Critical Making in Digital Humanities*](https://anastasiasalter.net/CriticalMaking2026/), the [*Distant Coding for the Digital Humanities*](https://anastasiasalter.net/DistantCoding/) MLA workshop (with Lai-Tze Fan), the [UMKC *Distant Coding* intensive](https://anastasiasalter.net/DistantCodingUMKC/), and [*DHSI 2026: DH Programming Pedagogy in the Age of AI*](https://anastasiasalter.net/DHSI_DH_AI_2026/) (with John Murray). Companion text: Emily K. Johnson and Anastasia Salter, [*Critical Making in the Age of AI*](https://github.com/amsucf/CritMakingAgeOfAI) (open access).
