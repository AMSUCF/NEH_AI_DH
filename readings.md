...
- Johnson, Emily K., and Anastasia Salter. *[Critical Making in the Age of AI](https://www.fulcrum.org/concern/monographs/zc77ss95p).* Open access.
- Littman, Michael L. *Code to Joy: Why Everyone Should Learn a Little Programming.* MIT Press, 2023. ([UCF library ebook](https://ebookcentral.proquest.com/lib/ucf/detail.action?docID=30319504))
...
### Higher-ed crisis and what an LLM is

- <span class="tag tag-light">Light</span> Berry, David M. ["The Limits of Computation: Joseph Weizenbaum and the ELIZA Chatbot."](https://ojs.weizenbaum-institut.de/index.php/wjds/article/view/106) *Weizenbaum Journal of the Digital Society* 3.3 (2023).
- <span class="tag tag-light">Light</span> Kirschenbaum, Matthew. ["Prepare for the Textpocalypse."](https://www.theatlantic.com/technology/archive/2023/03/ai-chatgpt-writing-language-models/673318/) *The Atlantic*, March 8, 2023.
...
### Vibe coding, harnesses, and what changes
...
- <span class="tag tag-standard">Standard</span> Willison, Simon. ["Agentic Engineering Patterns" (Introduction).](https://simonwillison.net/2026/Feb/23/agentic-engineering-patterns/) February 23, 2026.
...
- <span class="tag tag-standard">Standard</span> Bender, Emily, and Alex Hanna. *The AI Con*, Chapter 3: Leisure for Me, Gig Work for Thee.
- <span class="tag tag-deep">Deep</span> Walsh, Melanie, and Maria Antoniak. ["The Goodreads 'Classics': A Computational Study of Readers, Amazon, and Crowdsourced Amateur Criticism."](https://post45.org/2021/04/the-goodreads-classics-a-computational-study-of-readers-amazon-and-crowdsourced-amateur-criticism/) *Post45*, April 2021.

---

## Stage 2 — Visual Analysis (Weeks 5–6)

- <span class="tag tag-light">Light</span> Demsky, Ian. ["My Month with Midjourney."](https://electronicbookreview.com/publications/my-month-with-midjourney/) *Electronic Book Review*, April 2, 2023.
...
- <span class="tag tag-light">Light</span> Halperin, Brett. ["Hollywood Film Workers Strike Against AI: Understanding Algorithmic Resistance to Generative Cinematography."](https://stars.library.ucf.edu/elo2024/algorithmsandimaginaries/schedule/3/) ELO 2024.
- <span class="tag tag-light">Light</span> Crawford, Kate, and Trevor Paglen. ["Excavating AI."](https://excavating.ai/) 2019.
- <span class="tag tag-standard">Standard</span> Mitchell, Melanie. *Artificial Intelligence*, Part II: Looking and Seeing.
- <span class="tag tag-standard">Standard</span> Bender, Emily, and Alex Hanna. *The AI Con*, Chapter 5: Artifice or Intelligence? AI Hype in Art, Journalism, and Science.
- <span class="tag tag-deep">Deep</span> Coverage of generative video: [Microsoft Surface AI ads](https://www.theverge.com/news/656104/microsoft-surface-ad-generative-ai-copilot-intel), [ILM *Star Wars Field Guide*](https://decrypt.co/320224/ilm-makes-star-wars-field-guide-short-film-using-generative-ai), [Netflix in *El Eternauta*](https://www.theguardian.com/media/2025/jul/18/netflix-uses-generative-ai-in-show-for-first-time-el-eternauta), [Yelp restaurant videos](https://www.theverge.com/news/714944/yelp-ai-stitched-videos), [Grok deepfake controversy](https://www.theverge.com/report/718975/xai-grok-imagine-taylor-swifty-deepfake-nudes).
...
- <span class="tag tag-light">Light</span> Evans, Julia. [*So You Want to Be a Wizard.*](https://wizardzines.com/zines/wizard/) Wizardzines.
- <span class="tag tag-light">Light</span> Farrell, Henry. ["After Software Eats the World, What Comes Out the Other End?"](https://www.programmablemutter.com/p/after-software-eats-the-world-what) October 3, 2024.
- <span class="tag tag-light">Light</span> Ford, Paul. ["Timing My Vibe Coding."](https://ftrain.com/aboard-podcast-timing-my-vibe-coding) *The Aboard Podcast*, July 29, 2025.
- <span class="tag tag-standard">Standard</span> Martin, Meredith. ["Command Lines for the Humanities."](https://www.cambridge.org/core/journals/pmla/article/command-lines-for-the-humanities/097F959E6971063D05B085E698354BA2) *PMLA* 139.3 (2024): 541–547.
- <span class="tag tag-standard">Standard</span> Littman, Michael L. *Code to Joy*, Chapters 1–3 (Telling Computers What to Do; The What of Programming; Sequencing Commands).

### Bias, justice, and labor

- <span class="tag tag-light">Light</span> Benjamin, Ruha. ["The New Artificial Intelligentsia."](https://lareviewofbooks.org/article/the-new-artificial-intelligentsia/) *Los Angeles Review of Books*, October 18, 2024.
- <span class="tag tag-light">Light</span> Noble, Safiya Umoja. ["Algorithms Aren't Neutral: Safiya Noble on AI, Bias, and Building Public-Interest Technology."](https://calearninglab.org/myrobotteacher/mrt6/) *My Robot Teacher* podcast.
- <span class="tag tag-standard">Standard</span> Noble, Safiya Umoja. *Algorithms of Oppression*, Chapter 1: A Society, Searching. ([UCF library ebook](https://go.openathens.net/redirector/ucf.edu?url=https%3A%2F%2Fdoi.org%2F10.2307%2Fj.ctt1pwt9w5))
- <span class="tag tag-standard">Standard</span> Costanza-Chock, Sasha. *[Design Justice](https://design-justice.pubpub.org/)*, Introduction and Chapter 1. Open access.
...
- <span class="tag tag-standard">Standard</span> Willison, Simon (with Grace Huckins). ["How to Run an LLM on Your Laptop."](https://simonwillison.net/2025/Jul/18/how-to-run-an-llm-on-your-laptop/) *MIT Technology Review*, July 17, 2025.
- <span class="tag tag-standard">Standard</span> Mollick, Ethan. ["On Holding Back the Strange AI Tide."](https://www.oneusefulthing.org/p/on-holding-back-the-strange-ai-tide) *One Useful Thing.*
- <span class="tag tag-deep">Deep</span> Willison, Simon. *[Agentic Engineering Patterns](https://simonwillison.net/guides/agentic-engineering-patterns/)* (full guide; updated regularly).

---

## Practitioner blogs worth subscribing to

- Mollick, Ethan. *[One Useful Thing](https://www.oneusefulthing.org/)*
...
- Salter & Murray. *DH Programming Pedagogy in the Age of AI* (DHSI 2025) — see `dhsi.md`.
