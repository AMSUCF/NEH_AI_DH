...
We're going to take a tour through the Claude CLI, MCP, Hugging Face, and Ollama. Feel free to follow along if you have your own device, and we'll also talk about how to get access to the new Spark device CHDR has purchased as another way to try some of these tools later.
...
- **Your students likely will install these.** This is especially likely for anyone going into industry roles, library/archive work, or research-adjacent careers. Knowing what these tools *do*, even without running them, is part of what they need from us.
...
1. **Framing: demoing the power tools.** A tour through the Claude CLI, MCP, Hugging Face, and Ollama. Follow along if you have your own device, or try these tools later on the new CHDR Spark.
