...
- Source materials: `HumanitiesAI/weekfour.md` (distant reading), `weekfifteen.md` (Skills walkthrough), `weekfourteen.md` (Code Web for distant reading).
