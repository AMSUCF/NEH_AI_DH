...
5. **Three-models comparison.** Same prompt through Opus / Sonnet / Haiku in one Project. Discord-post which model you'd reach for first and for what — a paragraph, not a memo. The cohort's posts aggregate into the model-selection guide.
